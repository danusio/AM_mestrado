...
featSel <- function(df){
  ...
  mi_imp <- quantile(feat_imp,0.75,names = F) # mean(feat_imp) 
...
write.csv(predicoes,"predicoes_lm.csv")
write.csv(observ,"observ_lm.csv")
